...
extension SignUpFinshViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
		...
		if isSelected{
			self.signUpFinishtBtn.backgroundColor = UIColor.mainPurple
			self.signUpFinishtBtn.isEnabled = true
		}else{
			self.signUpFinishtBtn.backgroundColor = UIColor.lightGray
			self.signUpFinishtBtn.isEnabled = false
		}
    }
}
